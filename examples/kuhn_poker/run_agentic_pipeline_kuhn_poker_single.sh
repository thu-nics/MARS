...
ROLL_OUTPUT_DIR="./runs/kuhn_poker_single/$(date +%Y%m%d-%H%M%S)"
...
python examples/start_agentic_pipeline.py --config_path $CONFIG_PATH  --config_name agentic_val_kuhn_poker_single | tee $ROLL_LOG_DIR/custom_logs.log
