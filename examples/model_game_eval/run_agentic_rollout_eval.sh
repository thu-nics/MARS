...
ROLL_OUTPUT_DIR="./runs/model_game_eval/$(date +%Y%m%d-%H%M%S)"
...
python examples/start_agentic_rollout_pipeline.py --config_path $CONFIG_PATH  --config_name agentic_rollout_eval | tee $ROLL_LOG_DIR/custom_logs.log
