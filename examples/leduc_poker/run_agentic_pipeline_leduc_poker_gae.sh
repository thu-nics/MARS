...
ROLL_OUTPUT_DIR="./runs/leduc_poker/$(date +%Y%m%d-%H%M%S)"
...
python examples/start_agentic_pipeline.py --config_path $CONFIG_PATH  --config_name agentic_val_leduc_poker_gae | tee $ROLL_LOG_DIR/custom_logs.log
