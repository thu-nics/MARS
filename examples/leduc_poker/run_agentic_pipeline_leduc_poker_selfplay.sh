...
ROLL_OUTPUT_DIR="./runs/leduc_poker_selfplay/$(date +%Y%m%d-%H%M%S)"
...
python examples/start_agentic_pipeline.py --config_path $CONFIG_PATH  --config_name agentic_val_leduc_poker_selfplay | tee $ROLL_LOG_DIR/custom_logs.log