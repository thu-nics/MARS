...
ROLL_OUTPUT_DIR="./runs/connect_four_selfplay/$(date +%Y%m%d-%H%M%S)"
...
python examples/start_agentic_pipeline.py --config_path $CONFIG_PATH  --config_name agentic_val_connect4_selfplay | tee $ROLL_LOG_DIR/custom_logs.log
